...
This overview should help you navigate the project without needing to read the code in detail. For more about the Revy assistant itself, see [revy-details.md](revy-details.md).
