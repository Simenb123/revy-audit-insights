...
export function mapRow(row: any): MappedRow {
  ...
  const fieldMappings: Record<string, string[]> = {
    ...
    type_transaksjon: ['type_transaksjon', 'transaction_type', 'type'],
        kundenavn: ['kundenavn', 'customer_name', 'kunde', 'motpart'],
        kundeadresse: ['kundeadresse', 'customer_address', 'motpart_adresse'],
        leverandornavn: ['leverandornavn', 'supplier_name', 'leverandr', 'motpart'],
        leverandøradresse: ['leverandøradresse', 'supplier_address', 'motpart_adresse'],
