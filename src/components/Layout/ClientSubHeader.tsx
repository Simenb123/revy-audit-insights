...
const ClientSubHeader: React.FC<ClientSubHeaderProps> = ({
  ...
  return (
    <div
      data-sub-header
      className={cn(
        'sticky top-[var(--global-header-current-height)] z-40 shadow-sm h-[var(--sub-header-height)] px-6 bg-brand-primary text-white [&_*]:text-white [&_select]:z-50 [&_[role=tooltip]]:z-60',
