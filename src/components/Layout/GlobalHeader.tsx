...
const GlobalHeader: React.FC<GlobalHeaderProps> = ({ className = '' }) => {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-revio-500 border-b border-revio-600 grid grid-cols-3 items-center px-6 text-white h-[var(--global-header-height)] shadow-sm">
