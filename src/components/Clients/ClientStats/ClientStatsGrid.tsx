...
import KeyFigures from "../ClientDetails/ClientDashboard/KeyFigures";
...
const ClientStatsGrid = ({ clients, announcements, selectedClientId }: ClientStatsGridProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {selectedClientId && (
        <div className="mt-6">
          <KeyFigures clientId={selectedClientId} />
        </div>
      )}
    </div>
  );
