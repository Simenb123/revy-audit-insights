          ...
          <TabsContent value="import" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Last opp store CSV eller Excel-filer med aksjonærinformasjon fra Skatteetaten. 
                  Systemet håndterer filer opp til 500MB med millioner av rader ved hjelp av avansert batch-prosessering.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <LargeDatasetUploader
                  ...
                  chunkSize={10000} // 10K rader per chunk for store filer
                  onComplete={(results) => {
