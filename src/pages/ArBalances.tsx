...
import { useArBalances } from '@/hooks/useArApBalances';
import { useFiscalYear } from '@/contexts/FiscalYearContext';
import StickyClientLayout from '@/components/Layout/StickyClientLayout';
import ArBalanceTable from '@/components/ArAp/ArBalanceTable';
...
const ArBalances = () => {
  ...
  const { data: arBalances, isLoading: arLoading } = useArBalances(clientId || '');
