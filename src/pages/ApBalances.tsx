...
import { useApBalances } from '@/hooks/useArApBalances';
import { useFiscalYear } from '@/contexts/FiscalYearContext';
import StickyClientLayout from '@/components/Layout/StickyClientLayout';
import ApBalanceTable from '@/components/ArAp/ApBalanceTable';
...
const ApBalances = () => {
  ...
  const { data: apBalances, isLoading: apLoading } = useApBalances(clientId || '');
