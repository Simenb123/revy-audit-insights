-- Phase 5: Investment Holdings/Portfolios (Updated - excluding existing investment_transactions)
...
-- Update existing investment_transactions table to link to holdings
