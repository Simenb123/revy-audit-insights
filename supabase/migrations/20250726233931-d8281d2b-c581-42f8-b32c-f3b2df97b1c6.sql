-- PHASE 1: Drop ALL existing policies on problematic tables to break recursion
...
-- PHASE 2: Modify get_user_team_ids to be SECURITY DEFINER and avoid RLS
...
-- PHASE 3: Create SIMPLE policies using ONLY department and role checks (no team references)
