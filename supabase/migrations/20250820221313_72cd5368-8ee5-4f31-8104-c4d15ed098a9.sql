-- Manual user approval system implementation
...
-- Create view for pending users (superadmin only)
...
-- Grant access to pending users view for superadmins
CREATE POLICY "Superadmins can view pending users"
