-- Update optimized_analysis function to properly compute trial balance summary and cross-check
...
BEGIN
  ...
  SELECT
    ...
    -- Cross-check: properly calculate balanced status
    (
