...
INSERT INTO public.standard_accounts (standard_number, standard_name, account_type, line_type, display_order, is_total_line, sign_multiplier) VALUES
...
UPDATE public.standard_accounts SET parent_line_id = (SELECT id FROM public.standard_accounts WHERE standard_number = '19') WHERE standard_number IN ('10', '15');
UPDATE public.standard_accounts SET parent_line_id = (SELECT id FROM public.standard_accounts WHERE standard_number = '79') WHERE standard_number IN ('20', '30', '40', '50', '60', '70');
UPDATE public.standard_accounts SET parent_line_id = (SELECT id FROM public.standard_accounts WHERE standard_number = '155') WHERE standard_number IN ('90', '95', '100', '105', '106', '110', '115', '120', '125', '130', '135', '140', '141', '145', '150');

-- Set up calculation formulas
UPDATE public.standard_accounts SET calculation_formula = '19 + 79' WHERE standard_number = '80';
UPDATE public.standard_accounts SET calculation_formula = '80 + 155' WHERE standard_number = '160';
UPDATE public.standard_accounts SET calculation_formula = '160 + 165' WHERE standard_number = '280';