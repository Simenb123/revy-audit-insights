-- Update process_shareholders_batch function to use correct column names from shareholders_staging table
  ...
  LOOP
    BEGIN
      ...
      INSERT INTO public.share_companies (
        ...
        COALESCE(v_batch_record.navn_foretak, 'Ukjent selskap'),
        v_batch_record.year,
        p_user_id,
        0,
        0
