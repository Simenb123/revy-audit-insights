...
SET reveal_key = 'ulovlig_laan',
    reveal_content = 'CFO opplyser at selskapet ga et kortsiktig lån til daglig leder på 1,5 millioner kroner i desember. Lånet ble ikke rapportert til revisor eller styre, og det foreligger ingen dokumentasjon på vilkår eller sikkerhet. Dette utgjør en betydelig nærstående-transaksjon som må undersøkes nærmere.'
WHERE title = 'Spør CFO om uvanlige transaksjoner' AND step_number = 1;

UPDATE public.training_actions 
SET reveal_key = 'periodisering',
    reveal_content = 'Regnskapsføreren bekrefter at selskapet har periodisert inntekter på 2,3 millioner kroner i desember som egentlig tilhører januar 2024. Dette ble gjort for å "forbedre tallene" før årsavslutning. Periodigeringen er ikke i henhold til god regnskapsskikk.'
WHERE title = 'Gjennomgå periodiseringsposteringer' AND step_number = 1;

UPDATE public.training_actions 
SET reveal_key = 'varelager_nedskrivning',
    reveal_content = 'Lagertellingen avdekker varer til bokført verdi 3,8 millioner kroner som ikke kan selges grunnet teknisk foreldelse. Ledelsen har ikke foretatt nedskrivning, noe som overvurderer varelageret betydelig.'
WHERE title = 'Fysisk lagertelling og verdsettelse' AND step_number = 2;

UPDATE public.training_actions 
SET reveal_key = 'tapsrisiko_fordringer',
    reveal_content = 'Aldersanalysen viser at 4,2 millioner kroner av kundefordringene er over 90 dager gamle. Tre store kunder har betalingsproblemer, men selskapet har ikke avsatt tilstrekkelige tapsavsetninger. Dette utgjør en vesentlig risiko for overvurdering av fordringene.'
