-- Fase 3: Forenklet datastruktur (Fixed version)
...
('regnskap', 'Regnskap', 'Regnskapsstandarder og -regler', 'subject_area', 20, '#10B981', ARRAY['planning', 'execution'], ARRAY[]::TEXT[], 'medium'),
('skatt', 'Skatt', 'Skattelover og -regler', 'subject_area', 30, '#F59E0B', ARRAY['execution', 'completion'], ARRAY[]::TEXT[], 'medium'),
('juridisk', 'Juridisk', 'Lover, forskrifter og rettsavgjørelser', 'subject_area', 40, '#EF4444', ARRAY['planning'], ARRAY[]::TEXT[], 'high'),
...
('egenkapital', 'Egenkapital', 'Egenkapital og eierforhold', 'subject_area', 150, '#16A34A', ARRAY['execution'], ARRAY[]::TEXT[], 'low'),
...
('hvitvasking', 'Hvitvasking', 'Hvitvaskingsregler og -kontroll', 'compliance', 310, '#EF4444', ARRAY['planning', 'execution'], ARRAY[]::TEXT[], 'high'),
('baerekraft', 'Bærekraft', 'Bærekraftsrapportering og ESG', 'compliance', 320, '#059669', ARRAY['planning', 'execution'], ARRAY[]::TEXT[], 'medium'),
('finanstilsyn', 'Finanstilsyn', 'Finanstilsynets regler og veiledninger', 'compliance', 330, '#7C3AED', ARRAY['planning'], ARRAY[]::TEXT[], 'high');
...
-- 5. Opprett trigger for automatisk oppdatering av updated_at
