-- Fix datatype mismatch and column name issues in process_shareholders_batch function
...
BEGIN
  ...
  -- Update job status in import_jobs table (not shareholder_import_queue)
