...
BEGIN
  SELECT json_build_object(
    'total_assets', COUNT(*),
    'total_cost', COALESCE(SUM(purchase_price), 0),
    'total_book_value', COALESCE(SUM(book_value), 0),
    'total_accumulated_depreciation', COALESCE(SUM(accumulated_depreciation), 0),
